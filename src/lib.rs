...
pub use crate::fast::{
    BeveTypedSlice, read_complex_slice, to_vec_bool_slice, to_vec_complex_slice, to_vec_str_slice,
    to_vec_string_slice, to_vec_typed_slice, to_writer_typed_slice, typed_slice_size,
    write_bool_slice, write_complex_slice, write_str_slice, write_string_slice, write_typed_slice,
};
