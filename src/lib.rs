...
pub use crate::fast::{
    ...
    to_vec_complex64_slice, to_vec_complex_slice, to_vec_str_slice, to_vec_string_slice,
    to_vec_typed_slice, write_bool_slice, write_complex_slice, write_str_slice,
    write_string_slice, write_typed_slice,
};
